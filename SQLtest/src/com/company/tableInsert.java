...
public class tableInsert {
    ...
    public static void insert() {
        ...
        while (true) {
            ...
            if (m == 3) {
                System.out.println("以下为图书表:");
                tableSelect ts3 = new tableSelect();
                ts3.select("4");
                for (int i = 0; i < 6; i++) {
                    if (i == 0) {
                        System.out.println("输入图书号：");
            ...
            if (m == 4) {
                System.out.println("以下为管理员：");
                tableSelect ts4 = new tableSelect();
                ts4.select("5");
                for (int i = 0; i < 5; i++) {
                    if (i == 0) {
            ...
            if (m == 7) {
                System.out.println("以下为销售订单:");
                tableSelect ts2 = new tableSelect();
                ts2.select("9");
                for (int i = 0; i < 6; i++) {
                    if (i == 0) {
